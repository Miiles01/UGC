        ...
        <div className="min-h-screen overflow-x-hidden bg-white dark:bg-[#476500] text-black dark:text-white font-manrope selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black transition-colors duration-1000 ease-in-out relative">
          ...
          <main className="px-6 md:px-12 lg:px-24 pt-32 pb-24 max-w-7xl mx-auto flex flex-col gap-48 md:gap-64">
            ...
            <section id="sobre-mi" className="theme-section flex flex-col gap-8 w-full" data-theme="light">
              <div className="flex flex-col items-center md:items-start mb-8 md:mb-16 w-full">
                <h1 className="animated-title text-center md:text-left text-5xl sm:text-6xl md:text-[90px] lg:text-[130px] font-semibold tracking-tighter leading-tight text-black dark:text-white transition-colors duration-1000">
                  Mi misión<br />
                  es conectar
                </h1>
              </div>
              ...
              <div className="relative w-screen" style={{ left: "50%", right: "50%", marginLeft: "-50vw", marginRight: "-50vw" }}>
                <div className="animate-marquee gap-6 md:gap-8">
                  ...
                  {[...testimonials, ...testimonials].map((t, idx) => (
                    <div key={idx} className="testimonial-card flex-shrink-0 p-8 md:p-10 bg-black/20 rounded-3xl flex flex-col gap-6 transition-colors duration-1000 h-[300px] md:h-[320px] justify-between">
          ...
          <nav className="fixed top-0 left-0 right-0 z-[100] p-6 flex justify-between items-center pointer-events-none text-white">
            ...
            <button 
              ...
              className="pointer-events-auto w-10 h-10 rounded-full flex items-center justify-center hover:scale-105 transition-transform"
            >
